...
static uint8_t perm[256] = { 151, 160, 137,  91,  90,  15, 131,  13, 201,  95,  96,  53, 194, 233,   7, 225, 140,  36, 103,  30,  69, 142,   8,  99,
				      	      37, 240,  21,  10,  23, 190,   6, 148, 247, 120, 234,  75,   0,  26, 197,  62,   4, 252, 219, 203, 117,  35,  11,  32,
...
public:
	...
	perlin2D(uint64_t);
	~perlin2D();
	double noise(double, double, double z = 0);

private:
	double fade(double);
	double lerp(double, double, double);
	double grad(int, double, double, double z = 0);
