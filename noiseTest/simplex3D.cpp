...
simplex3D::simplex3D(int64_t seed) : simplex3D()
{
  reseed(seed);
}

void simplex3D::reseed(int64_t seed)
{
  short source[256];
...
double simplex3D::getNoise(double x, double y, double z) const
{
...
double simplex3D::extrapolate(int xsb, int ysb, int zsb, double dx, double dy, double dz) const
{
